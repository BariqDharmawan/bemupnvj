    ...
    constructor(ctx) {
        ...
        this.schema = Validator_1.schema.create({
            title: Validator_1.schema.string({ trim: true }, [
                ...
                Validator_1.rules.unique({ table: 'blogs', column: 'title' }),
                Validator_1.rules.minLength(3),
                Validator_1.rules.maxLength(100)
            ]),
            cover: Validator_1.schema.file({
                size: '2mb',
...
exports.default = StoreArticleValidator;
//# sourceMappingURL=StoreArticleValidator.js.map